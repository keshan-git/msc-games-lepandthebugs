 ...
 */
public class GameOverOSDUnit extends OSDUnit
{
    public GameOverOSDUnit(int xPosition, int yPosition)
    {
        updatePosition(xPosition, yPosition);
        ImageIcon imageIcon = new ImageIcon(getClass().getResource("/lepandthebugs/scene/resources/game over.png"));
